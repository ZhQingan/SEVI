...
data_path = "/path/to//datasets/benchmark/image/pope/"
...
def chair_calculation(response_file):
    ...
    for start_idx in tqdm(
        range(0, len(loaded_json), 50), desc="Generating CHAIR Input"
    ):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--response_file",
        default="/path/to//projects/VCD-master/experiments/CHAIR/output/llava15_coco_chair_descriptions_seed42_vcd_select_attn_7.jsonl",
    )
