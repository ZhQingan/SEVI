...
conv_llava_llama_3 = Conversation(
    ...
    # tokenizer_id="/path/to/models/Meta-Llama-3-8B",
    # tokenizer=safe_load_tokenizer("/path/to/models/Meta-Llama-3-8B"),
    tokenizer_id="/path/to/models/Meta-Llama-3-8B-Instruct",
    tokenizer=safe_load_tokenizer("/path/to/models/Meta-Llama-3-8B-Instruct"),
